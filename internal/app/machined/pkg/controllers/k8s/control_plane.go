...
// ControlPlaneAuthenticationConfigController manages k8s.AuthenticationConfig based on configuration.
type ControlPlaneAuthenticationConfigController = transform.Controller[*config.MachineConfig, *k8s.AuthenticationConfig]

// NewControlPlaneAuthenticationConfigController instanciates the controller.
func NewControlPlaneAuthenticationConfigController() *ControlPlaneAuthenticationConfigController {
	return transform.NewController(
