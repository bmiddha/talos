...
func (ctrl *ControlPlaneStaticPodController) manageAPIServer(ctx context.Context, r controller.Runtime, _ *zap.Logger,
	...
	builder := argsbuilder.Args{
		...
		"structured-authentication-config": filepath.Join(constants.KubernetesAPIServerConfigDir, "structured-authentication-config.yaml"),
		"structured-authorization-config": filepath.Join(constants.KubernetesAPIServerConfigDir, "structured-authorization-config.yaml"),
