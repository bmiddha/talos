...
```
      ...
      --cni-bundle-url string                    URL to download CNI bundle from (VM only) (default "https://github.com/siderolabs/talos/releases/download/38263841e-dirty/talosctl-cni-bundle-${ARCH}.tar.gz")
...
```
  ...
  -i, --image string         the container image to use for performing the install (default "ghcr.io/siderolabs/installer:38263841e-dirty")
