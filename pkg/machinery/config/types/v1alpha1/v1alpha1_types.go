...
type APIServerConfig struct {
	...
	//   schema:
	//     type: object
	StructuredAuthenticationConfig Unstructured `yaml:"structuredAuthenticationConfig,omitempty"`
	//   description: |
	//     Configure the API server authorization.
	//   schema:
	//     type: object
	StructuredAuthorizationConfig Unstructured `yaml:"structuredAuthorizationConfig,omitempty"`
	//   description: |
