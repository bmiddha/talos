...
const (
	...
	// StructuredAuthenticationConfigPath is the path to the structured-authentication-config.yaml relative to initramfs.
	StructuredAuthenticationConfigPath = KubernetesConfigBaseDir + "/" + "structured-authentication-config.yaml"

	// StructuredAuthorizationConfigPath is the path to the structured-authorization-config.yaml relative to initramfs.
	StructuredAuthorizationConfigPath = KubernetesConfigBaseDir + "/" + "structured-authorization-config.yaml"
