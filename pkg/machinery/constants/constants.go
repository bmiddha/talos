...
const (
	...
	// AuthenticationConfigPath is the path to the authentication-config.yaml relative to initramfs.
	AuthenticationConfigPath = KubernetesConfigBaseDir + "/" + "authentication-config.yaml"
